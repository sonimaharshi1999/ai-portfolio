...
const expertiseData = [
  {
    ...
    text: "Self-healing locators, visual regression testing, and AI-powered test generation with Playwright. Building intelligent automation that adapts and repairs itself.",
    tag: "INTELLIGENT QA",
  ...
  },
  {
    number: "02",
    title: "RAG & LLM Tools",
    text: "Retrieval-augmented generation systems, document Q&A pipelines, and LLM developer tooling. Turning unstructured knowledge into queryable intelligence.",
    tag: "RAG & LLM",
  ...
  },
  {
    ...
    text: "FastAPI and Flask backends, ML model serving, and responsive frontends. End-to-end AI application development from prototype to production.",
    tag: "AI APPLICATIONS",
    gradient: "from-[#220a0d] via-[#131313] to-[#0a0a0a]"
  },
  {
    number: "04",
    title: "Insurance & Domain AI",
    text: "NLP pipelines for policy extraction, clause classification, and business rule validation. Deep domain expertise in insurance technology automation.",
    tag: "DOMAIN AI",
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
          ...
          <p className="text-white/60 text-xs md:text-sm font-light leading-relaxed max-w-xs">
            Merging QA automation, AI-powered testing, RAG pipelines, and insurance domain expertise into production-ready solutions.
          </p>
        </div>
