        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">Maharshi Soni</span>, a Senior QA Automation Engineer and AI developer with 5+ years of experience building JavaScript-based UI/API automation frameworks.
              </p>
              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">
                Specialized in PolicyCenter, BillingCenter, and ClaimCenter automation across 15+ insurance lines. Now building AI-powered testing tools, RAG systems, and agentic AI applications.
              </p>
            </div>

            <div className="pt-8 flex flex-wrap gap-2 relative z-10">
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">QA Automation</span>
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">AI & RAG Systems</span>
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">Insurance Domain</span>
            </div>
          </div>
            ...
            <div className="space-y-5 relative z-10">
              ...
              <ul className="space-y-3.5 text-sm text-white/80 font-light">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>Built <strong className="text-white">$3M SaaS automation product</strong> at PwC from the ground up.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Led a <strong className="text-white">20-person QA team</strong> across multiple insurance automation projects.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Automated <strong className="text-white">15+ insurance lines</strong> across PolicyCenter, BillingCenter & ClaimCenter.</span>
                </li>
              </ul>
            </div>
          ...
          >
            ...
            <div className="space-y-2 text-left relative z-10">
              ...
              <p className="text-base md:text-lg font-semibold text-white">Equipped with industry-grade instruments for automation & AI.</p>
            </div>

            <div className="flex flex-wrap items-center gap-3 relative z-10">
              {['Python', 'JavaScript', 'Playwright', 'FastAPI', 'Docker', 'FAISS', 'Selenium'].map((tech, idx) => (
                <span
                  key={idx}
