...
const skillCategories = [
  {
    title: 'Languages',
    desc: 'Core programming languages powering automation frameworks, AI pipelines, and full-stack applications.',
    tag: 'CORE LANGUAGES',
    skills: ['Python', 'JavaScript', 'Java', 'SQL']
  },
  {
    title: 'Test Automation',
    desc: 'Building robust end-to-end test frameworks with modern tools for UI, API, and BDD-driven testing workflows.',
    tag: 'QA FRAMEWORKS',
    skills: ['Playwright', 'TestCafe', 'Cucumber', 'Selenium', 'BDD/Gherkin']
  },
  {
    title: 'AI & Machine Learning',
    desc: 'Developing intelligent applications with ML models, vector search, embeddings, and GPU-accelerated inference pipelines.',
    tag: 'INTELLIGENCE',
    skills: ['scikit-learn', 'FAISS', 'ChromaDB', 'sentence-transformers', 'NVIDIA NIM']
  },
  {
    title: 'Web Frameworks',
    desc: 'Building high-performance backends and interactive data apps with modern Python web frameworks.',
    tag: 'BACKENDS',
    skills: ['FastAPI', 'Flask', 'Streamlit']
  },
  {
    title: 'CI/CD & DevOps',
    desc: 'Containerized deployments, automated pipelines, and version-controlled workflows for production-grade systems.',
    tag: 'INFRASTRUCTURE',
    skills: ['Docker', 'TeamCity', 'Azure DevOps', 'Git', 'Bitbucket']
  },
  {
    title: 'Data & Analysis',
    desc: 'Data manipulation, numerical computing, NLP preprocessing, and visualization for analytics and ML pipelines.',
    tag: 'DATA TOOLS',
    skills: ['pandas', 'NumPy', 'nltk', 'matplotlib', 'JIRA']
  },
];
