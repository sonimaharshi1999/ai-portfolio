...
// Authentic Project Data based on Maharshi Soni's engineering portfolio
const projectsData = [
  {
    title: "Playwright AI Test Generator",
    category: "AI-Powered QA",
    description: "NLP-powered Playwright test generation from natural language descriptions. Converts plain English into robust E2E tests.",
    tags: ["Python", "Playwright", "NLP", "AI"],
    match: "99%",
    episode: "S01 E01",
    link: "https://github.com/sonimaharshi1999/playwright-ai-test-generator"
  },
  {
    title: "LangGraph QA Agent",
    category: "Agentic AI",
    description: "Autonomous testing agent with multi-node graph, self-healing locators, and Slack reporting integration.",
    tags: ["LangGraph", "Python", "Slack API", "AI"],
    match: "99%",
    episode: "S01 E02",
    link: "https://github.com/sonimaharshi1999/langgraph-qa-agent"
  },
  {
    title: "Self-Healing Locator Engine",
    category: "ML & Automation",
    description: "Auto-fixes broken CSS/XPath selectors using ML models. Keeps test suites resilient against UI changes.",
    tags: ["Python", "scikit-learn", "Selenium", "ML"],
    match: "98%",
    episode: "S01 E03",
    link: "https://github.com/sonimaharshi1999/self-healing-locator-engine"
  },
  {
    title: "AI Visual Regression Tester",
    category: "Computer Vision",
    description: "Computer vision-powered screenshot comparison for visual regression testing across builds.",
    tags: ["Python", "OpenCV", "Computer Vision", "QA"],
    match: "97%",
    episode: "S01 E04",
    link: "https://github.com/sonimaharshi1999/ai-visual-regression-tester"
  },
  {
    title: "BDD Scenario Generator",
    category: "NLP & Testing",
    description: "NLP generates Gherkin/Cucumber scenarios from natural language requirements documents.",
    tags: ["Python", "NLP", "Cucumber", "Gherkin"],
    match: "98%",
    episode: "S01 E05",
    link: "https://github.com/sonimaharshi1999/bdd-scenario-generator"
  },
  {
    title: "Flaky Test Detector",
    category: "ML & QA",
    description: "ML model identifies flaky tests from JUnit reports, reducing false failures and CI noise.",
    tags: ["Python", "scikit-learn", "JUnit", "ML"],
    match: "96%",
    episode: "S01 E06",
    link: "https://github.com/sonimaharshi1999/flaky-test-detector"
  },
  {
    title: "RAG QA Knowledge Base",
    category: "RAG Systems",
    description: "Retrieval-augmented generation system for QA documentation search and intelligent knowledge retrieval.",
    tags: ["Python", "FAISS", "RAG", "LLM"],
    match: "99%",
    episode: "S01 E07",
    link: "https://github.com/sonimaharshi1999/rag-qa-knowledge-base"
  },
  {
    title: "Insurance Document Analyzer",
    category: "Domain AI",
    description: "NLP pipeline extracts clauses and key terms from insurance policy documents for automated analysis.",
    tags: ["Python", "NLP", "Insurance", "FastAPI"],
    match: "97%",
    episode: "S01 E08",
    link: "https://github.com/sonimaharshi1999/insurance-document-analyzer"
  },
  {
    title: "AI Study Assistant",
    category: "RAG & Education",
    description: "RAG-powered study assistant with FAISS vector search and Claude AI for intelligent document Q&A.",
    tags: ["Python", "FAISS", "Claude", "RAG"],
    match: "98%",
    episode: "S01 E09",
    link: "https://github.com/sonimaharshi1999/AI_study_assistant"
  },
  {
    title: "AI Resume Analyzer",
    category: "AI Tools",
    description: "ATS scoring engine with multi-LLM support for resume analysis, feedback, and optimization.",
    tags: ["Python", "LLM", "FastAPI", "NLP"],
    match: "97%",
    episode: "S01 E10",
    link: "https://github.com/sonimaharshi1999/AI_resume_analyzer"
  }
];
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      const getGridPos = (index) => {
        ...
        else if (index < 6) { row = 1; col = index - 3; }
        else if (index < 9) { row = 2; col = index - 6; }
        else { row = 3; col = index - 9; }
        return { row, col };
      };
        ...
        <div className="relative w-0 h-0 transform-style-3d">
          ...
          {projectsData.map((project, i) => (
            <a
              ...
              className="hidden md:block absolute w-[80vw] md:w-[33vw] max-w-[380px] aspect-[16/10] will-change-transform no-underline"
              style={{ zIndex: 10 + i }}
            >
      ...
      >
        ...
        {projectsData.map((project, i) => (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="shrink-0 w-[78vw] aspect-[16/11] snap-center will-change-transform relative z-10 no-underline"
          >
